...
public class ClientThread extends Thread {
    ...
    private String filePath = "D:\\Users\\kinsh\\Desktop\\Servers Details Project\\servers.txt";
    ...
    private void doAction(String msg) throws IOException, IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, BadPaddingException {
        switch (msg){
    ...
    private String getTxtFileContent() throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, BadPaddingException {
        FileReader fr = null;
        StringBuilder stringBuilder = new StringBuilder();
        ...
        if (fileLastTimeModifed == Server.tempLastModified){
            ...
            try {
                ...
                // encrypt the data
                String encryptedData = Base64.getEncoder().encodeToString(encryptText(stringBuilder.toString()));
